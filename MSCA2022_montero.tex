...
\section{Excellence}
\vspace{-6pt}
\input{source/1.1_quality}
\input{source/1.2_methodology}
\input{source/1.3_training}
...
\section{Impact}
\label{sec:impact}
\input{source/2.1_impactresearcher}
\input{source/2.2_suitability}
\input{source/2.3_impactmeasures}
...
\input{source/3.1_implementationworkplan}
\input{source/3.2_implementationmangement}
